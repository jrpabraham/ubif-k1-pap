...
<<K1packages, eval = FALSE, results = 'hide', message = FALSE, warning = FALSE>>=
...
<<K1functions, eval = FALSE, results = 'hide'>>=
...
<<K1data, eval = FALSE, results = 'hide'>>=
...
<<K1balance, eval = FALSE, results = 'hold'>>=
...
<<K1teffects, eval = FALSE, results = 'hold'>>=
...
<<K1covadj, eval = FALSE, results = 'hold'>>=
